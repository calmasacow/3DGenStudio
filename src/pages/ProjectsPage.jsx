...
const CHANGE_LOG_ENTRIES = [
  ...
  },
  {
    ...
    date: '2026-07-20',
    items: [
			'MCP Server: Connect your AI with 3D Gen Studio',
			'Graph Page: Added Reorganize button',
			'Graph Page: Save the last position and zoom level',
			'Graph Page: Simplified Image Node Actions',
			'Desktop App: Fixed Wiki',
			'Desktop App: Auto-start python services in Settings',
			'3D Mesh: Thumbnail is now generated by mesh-tools (python)'
    ],
  },
  {
    version: 'v1.5.0',
